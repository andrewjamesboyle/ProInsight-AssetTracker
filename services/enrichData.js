...
async function enrichData(contact) {
  ...
  try {
    enrichedData = properties.map((property) => ({
      ...
      "Loan Type": property.FirstLoanType || null,
      "Loan Date": property.FirstDate || null,
      "Loan Purpose": property.FirstPurpose || null,
      "Loan Rate": property.FirstRate || null,
      "Loan Rate Type": property.FirstRateType || null,
      "Loan Amount LTV": property.FirstAmountLTV || null,
      Lender: property.FirstLenderOriginal || null,
      "Second Loan Amount": property.SecondAmount || null,
      "Second Loan Type": property.SecondLoanType || null,
      "Second Loan Date": property.SecondDate || null,
      "Second Loan Purpose": property.SecondPurpose || null,
      "Second Loan Rate": property.SecondRate || null,
      "Second Loan Rate Type": property.SecondRateType || null,
      "Second Loan Amount LTV": property.SecondAmountLTV || null,
